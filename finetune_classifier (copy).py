...
from data.classification import QNLITask, CoLATask, MNLITask, WNLITask, XNLITask, Weibo3Task,WaimaiTask
...
tensorpath='./runs/%s/%s'%(task_name,time.datetime())
...
def log_eval(batch_id, batch_num, metric, step_loss, log_interval,epoch_id):
    ...
    logging.info(eval_str, batch_id + 1, batch_num, step_loss / log_interval, epoch_id*lendev+batch_id+1)
